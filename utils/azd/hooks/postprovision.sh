...
AZURE_OPENAI_CHAT_API_VERSION=$(azd env get-value AZURE_OPENAI_CHAT_API_VERSION)
AZURE_OPENAI_CHAT_DEPLOYMENT_USE_V1=$(azd env get-value AZURE_OPENAI_CHAT_DEPLOYMENT_USE_V1)
AZURE_OPENAI_REASONING_DEPLOYMENT_ID=$(azd env get-value AZURE_OPENAI_REASONING_DEPLOYMENT_ID)
AZURE_OPENAI_REASONING_API_VERSION=$(azd env get-value AZURE_OPENAI_REASONING_API_VERSION)
AZURE_OPENAI_REASONING_DEPLOYMENT_USE_V1=$(azd env get-value AZURE_OPENAI_REASONING_DEPLOYMENT_USE_V1)
...
AZURE_COSMOS_DATABASE_NAME=$(azd env get-value AZURE_COSMOS_DATABASE_NAME)
AZURE_COSMOS_COLLECTION_NAME=$(azd env get-value AZURE_COSMOS_COLLECTION_NAME)
